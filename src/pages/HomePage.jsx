...
function HomePage() {
  ...
  const isDesktopSmall = useMediaQuery(theme.breakpoints.up('md'));
  const isDesktopLarge = useMediaQuery(theme.breakpoints.up('lg'));
  const isDesktopExtraLarge = useMediaQuery(theme.breakpoints.up('xl'));
  ...
  useEffect(() => {
    ...
    // Show the text after 0.5 seconds
              ...
              <Typography
                sx={{
                  ...
                  fontSize: {
                    ...
                    sm: 32, // font size for small screens and up
                    lg: 40, // font size for large screens and up
                  },
                  fontWeight: 600,
                  wordWrap: 'break-word',
                }}>

...
function HomePage() {
  ...
  return (
    <div className="relative flex flex-col items-center justify-center bg-gray-100">
              ...
              <div className="shadow-lg rounded-lg border border-gray-200">
                ...
                <div className="p-4">
                  ...
                  <div className="flex items-center text-sm text-gray-600">
                    {slide.organization}
                    <FontAwesomeIcon icon={faCheckCircle} className="text-blue-500 ml-1" />
                  </div>
      ...
      <div className="w-full bg-white p-6 mt-10" style={{ borderRadius: "20px" }}>
        <div className="w-full flex justify-between items-center mb-6">
          <h2 className="text-2xl font-bold text-gray-800">Event Pilihan</h2>
          <a href="#" className="text-sm text-blue-500">Lihat Semua</a>
        </div>
        <div className="flex space-x-4 mb-6">
          <button className="px-4 py-2 text-white rounded-full hover:bg-blue-600 transition-colors duration-300 ease-in-out" style={{ background: '#7AB2B2' }}>Donasi</button>
          <button className="px-4 py-2 bg-gray-200 text-gray-800 rounded-full">Volunteer</button>
        </div>
        <Swiper
          spaceBetween={20}
          slidesPerView={5}
            ...
            <SwiperSlide key={slide.id}>
              <div className="shadow-lg rounded-lg border border-gray-200">
                ...
                <div className="p-4">
                  ...
                  <div className="text-sm text-gray-600 mb-1">Target: {slide.target}</div>
                  <div className="text-sm text-gray-600 mb-1 text-right">{slide.percentage}</div>
                </div>
              </div>
            </SwiperSlide>
          ))}
